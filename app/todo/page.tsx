	...
	return (
		<>
			...
			>
				...
				<div className={cn(`bg-red-300/20 w-full h-full grid grid-cols-2 gap-4 px-2`)}>
					<ul className={cn(`bg-green-300/30 h-30 grid grid-cols-[2rem_1fr] gap-4`)}>
						{tasks.map((task) => (
							<li key={task.id} className={cn(`grid col-span-2 grid-cols-subgrid`)}>
								<div> {/* circle */}
