...
export function createCommunicationLog(fastify: FastifyInstance) {
...
export function listCommunicationLogs(fastify: FastifyInstance) {
...
export function getCommunicationLog(fastify: FastifyInstance) {
...
export function updateCommunicationLog(fastify: FastifyInstance) {
