...
export function listRegions(fastify: FastifyInstance) {
...
export function getRegion(fastify: FastifyInstance) {
...
export function createRegion(fastify: FastifyInstance) {
...
export function updateRegion(fastify: FastifyInstance) {
...
export function assignBranchToRegion(fastify: FastifyInstance) {
