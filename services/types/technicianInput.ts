...
export interface TechnicianInput {
	...
	recentCompletionRate: number; // 0.0 – 1.0
	...
	// Distance cache (optional — computed internally by the dispatch pipeline,
	// do not rely on this value being populated from outside the algo layer)
	distanceMiles?: number;
}

export const createMockTechnician = (
