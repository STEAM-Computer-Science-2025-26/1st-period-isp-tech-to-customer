...
const Fab = ({ size, icon, className, iconClassName, ...props }: FabProps) => {
	return (
		<button
			className={cn(
				"fixed bottom-2 backdrop-blur-xs right-2 bg-background-secondary/50 text-text-secondary rounded-lg flex flex-row items-center justify-center p-2 border border-background-secondary",
