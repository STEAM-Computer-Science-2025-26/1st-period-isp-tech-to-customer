...
const ListPanel = <T extends Record<string, unknown>>({
	...
	return (
		<div
			className={cn(
				"w-full bg-background-primary rounded-xl border border-background-secondary relative pt-12",
				className
			)}
		>
			<div
				className={cn(
					"border-b border-secondary/50 h-12 absolute top-0 inset-x-4 items-center grid"
				)}
				style={{
