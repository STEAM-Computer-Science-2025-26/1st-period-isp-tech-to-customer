...
export default function Header({ sidebarAutoCollapse, sidebarIsStrip }: HeaderProps) {
	const { lgUp } = useBreakpoints();

	return (
		<div className={clsx("fixed ease duration-300 transition-all top-0 z-40 inset-x-0 h-20 pt-4 px-4 bg-linear-to-t from-transparent to-background-main to-50%",
			lgUp
				? sidebarAutoCollapse
					? "pl-4"
