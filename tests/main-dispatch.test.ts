import { dispatch, batchDispatch, overrideAssignment, getDispatchStats } from '../algo/main-dispatch';
...
describe('Main Dispatch Integration Tests', () => {
    ...
    test('6.3.6 Manual Override', () => {
        ...
        const result = dispatch(normalJob, technicians);
        const overridden = overrideAssignment(result, 'tech-002', 'Bob has existing customer relationship with this client');
    ...
    test('6.3.7 Dispatch Statistics', () => {
        ...
        const batchResults = batchDispatch([normalJob, emergencyJob, impossibleJob], technicians);
