...
// Route handlers
// ============================================================
export function listEmployees(fastify) {
...
export function getEmployee(fastify) {
...
export function createEmployee(fastify) {
...
export function updateEmployee(fastify) {
...
export function deleteEmployee(fastify) {
...
export function registerEmployeeRoutes(fastify) {
