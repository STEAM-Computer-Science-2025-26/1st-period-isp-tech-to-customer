...
export function hashVerificationSessionToken(sessionToken) {
...
function getCodeKey() {
    ...
    throw new Error("Missing VERIFICATION_CODE_KEY. Set it to a base64-encoded 32-byte key.");
}
export function encryptVerificationCode(code) {
...
export function decryptVerificationCode(payload) {
    const key = getCodeKey();
